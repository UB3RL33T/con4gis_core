...
( function() {
	...
	var bbcodeMap = { b: 'strong', u: 'u', i: 'em', left:'div',right:'div',center:'div',block:'div',justify:'div',bgcolor: 'span', color: 'span', size: 'span', quote: 'blockquote', code: 'code', url: 'a', email: 'span', img: 'span', '*': 'li', list: 'ol' },
		convertMap = { strong: 'b', b: 'b', u: 'u', em: 'i', i: 'i', code: 'code', li: '*' },
		tagnameMap = { strong: 'b', em: 'i', u: 'u', li: '*', ul: 'list', ol: 'list', code: 'code', a: 'link', img: 'img', blockquote: 'quote' },
		stylesMap = { color: 'color', size: 'font-size', bgcolor: 'background-color'},
